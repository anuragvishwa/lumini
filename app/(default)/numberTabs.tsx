          ...
          <div className="max-w-sm mx-auto md:max-w-none grid gap-12 md:grid-cols-3 md:gap-x-10 md:gap-y-10 items-start">
            ...
            <article data-aos="fade-up">
              ...
              <p className="text-md text-slate-500">
                Our AI agents are trained emulate the behavior of your sales
                team. Sales agents are not a one-type-fits-all. We allow for
                advanced customization for personality, tone, and more.
              </p>
            </article>
            ...
            <article data-aos="fade-up" data-aos-delay="100">
              ...
              <p className="text-md text-slate-500">
                Our Reranker aims to predict what products each user is more
                likely to purchase. These models are trained individually for
                each store with advanced low latency technology.
              </p>
            </article>
            ...
            <article data-aos="fade-up" data-aos-delay="200">
              ...
              <p className="text-md text-slate-500">
                We train Large AI models to customize the information shown to
                each user. We adjust product recommendations, FAQs, and the
                layout of your website for each user.
              </p>
            </article>
          </div>
        </div>
